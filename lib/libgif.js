// Modified by zrispo, control-f zrispo to see da things
...
((root, factory) => {
    ...
    const SuperGif = opts => {
        ...
        for (const i in opts ) { options[i] = opts[i] }
                ...
                if (options.is_vp) {
                    ...
                    if (false) {
                        if (!ctx_scaled) {
                            ...
                            var t = options.vp_t/get_canvas_scale();
                            var w = options.vp_w/get_canvas_scale();
                            var h = options.vp_h/get_canvas_scale();
                        }
                        ctx.rect(l,t,w,h);
                        ctx.stroke();
                    }
